...
function Home() {
  ...
  return (
    <div
      id="Home"
      className="flex flex-col lg:flex-row items-center justify-around lg:h-screen"
    >
      <div className="text-center w-2/3 lg:ml-44 lg:text-left">
        ...
        <div className="flex gap-10 lg:gap-20 mt-10 lg:mt-20 justify-center lg:justify-start">
          ...
          <a
            href="https://github.com/WevdevSandy/sandy-chaudhary"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://x.com/WebDev_Sandy_"
            target="_blank"
            rel="noopener noreferrer"
          >
